...
public class InsulaWhiteOre extends BlockBase {

	public InsulaWhiteOre(String name) {
	...
	public Item getItemDropped(IBlockState state, Random random, int i2 ){
		return ModItems.insulawhitejewel;
	}
	...
	@Override
	public InsulaWhiteOre setCreativeTab(CreativeTabs tab) {
