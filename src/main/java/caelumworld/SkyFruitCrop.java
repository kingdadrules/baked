...
public class SkyFruitCrop extends BlockCrops {

	protected String name;

	public SkyFruitCrop(String name) {
		this.name = name;
	...
	@Override
	public Item getSeed() {
		return ModItems.skyfruitseed;
	}
	
	@Override
	public Item getCrop() {
		return ModItems.skyfruit;
	}
	...
	@Override
	public SkyFruitCrop setCreativeTab(CreativeTabs tab) {
