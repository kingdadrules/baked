...
public class InsulaBlackOre extends BlockBase {

	public InsulaBlackOre(String name) {
	...
	public Item getItemDropped(IBlockState state, Random random, int i2 ){
		return ModItems.insulablackjewel;
	}
	...
	@Override
	public InsulaBlackOre setCreativeTab(CreativeTabs tab) {
