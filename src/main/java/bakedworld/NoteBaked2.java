...
public class NoteBaked2 extends GuiScreen
{
    ...
    public NoteBaked2()
    {
        ...
        stringPageText[0] = " Ender Lillies grow the pearls I will need.\nStirling generators for power & SAG Mills sound good.";
        stringPageText[1] = "Crucibles for lava.. Make Simple Cobble Gen. Sorted!\nMake Auto sieves, Get it all automated then look at portal.";
        stringPageText[2] = "Surround the right book with 8 diamonds to upgrade sieve efficiency, or emeralds to upgrade sieve fortune.\nNeed stuff from other worlds first though.";
        
        stringPageText[3] = "Old diagram I found pointed to a world called Arbos next.\nPortal blocks seem common to all, tune them to world with activator, build as per nether.\n All return portals point back here. ";
