...
public class SilvamYellowOre extends BlockBase {

	public SilvamYellowOre(String name) {
	...
	public Item getItemDropped(IBlockState state, Random random, int i2 ){
		return ModItems.silvamyellowjewel;
	}
	...
	@Override
	public SilvamYellowOre setCreativeTab(CreativeTabs tab) {
