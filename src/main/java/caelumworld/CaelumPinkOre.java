...
public class CaelumPinkOre extends BlockBase {

	public CaelumPinkOre(String name) {
	...
	public Item getItemDropped(IBlockState state, Random random, int i2 ){
		return ModItems.caelumpinkjewel;
	}
	...
	@Override
	public CaelumPinkOre setCreativeTab(CreativeTabs tab) {
