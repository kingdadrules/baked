...
public class NoteSilvam1 extends GuiScreen
{
    ...
    public NoteSilvam1()
    {
        ...
        stringPageText[0] = "Flame fruit + infused coal = superfuel ... plant them?\nMine for yellow jewels.\nCrushed Eggs>blocks>leather/feathers/transformer module.";
        stringPageText[1] = "Key block... Right click egg shell block with transformer\nDiagram shows Insula as next world.";
