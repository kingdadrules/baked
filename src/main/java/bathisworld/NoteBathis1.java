...
public class NoteBathis1 extends GuiScreen
{
    ...
    public NoteBathis1()
    {
        ...
        stringPageText[0] = "Lots of blocks, ladders & fences should sort out getting down & breathing.\nMaybe make some diving kit after I collect enough stuff.\nMine for lead & jewels / kill skellies?";
        stringPageText[1] = "Get full armor to match.\nSpeed up crucible with magma.\nSieved weed block??\nTransformer ... right click weed block for key.\nDiagram shows Silvam as next world.";
