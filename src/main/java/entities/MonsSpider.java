...
public class MonsSpider extends EntitySpider {

	public MonsSpider(World worldIn) {
		super(worldIn);
	}
	...
	public static final ResourceLocation LOOT = new ResourceLocation(main.baked.modId, "entities/monsspider");
