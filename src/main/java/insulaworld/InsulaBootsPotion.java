...
public class InsulaBootsPotion extends InsulaBoots {
	private final PotionEffect potionEffect;
	private String name;

	public InsulaBootsPotion(final ArmorMaterial material, final EntityEquipmentSlot equipmentSlot, final PotionEffect potionEffect, String name) {
	...
	@Override
	public InsulaBootsPotion setCreativeTab(CreativeTabs tab) {
