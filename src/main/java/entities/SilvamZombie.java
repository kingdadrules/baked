...
public class SilvamZombie extends EntityZombie{

	public SilvamZombie(World worldIn) {
		super(worldIn);
	...
	public static final ResourceLocation LOOT = new ResourceLocation(main.baked.modId, "entities/silvamzombie");
