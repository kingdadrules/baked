...
public class NoteColetus1 extends GuiScreen
{
    ...
    public NoteColetus1()
    {
        ...
        stringPageText[0] = "Need lots of spores./nCan crush stick fungus & Sieve for jewels.\nThe cows are incredibly qiuck, but I need the bones.";
        stringPageText[1] = "I sense the end of this quest is nearer now.\nDiagram shows Frigus as next world.";
