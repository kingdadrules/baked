...
public class MyPearl extends Item {

	protected String name;

	public MyPearl(String name) {
		this.name = name;
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
	 {
    	 ...
    	 player.addPotionEffect(new PotionEffect(Potion.getPotionById(13), 600, 2)); 
	...
	@Override
	public MyPearl setCreativeTab(CreativeTabs tab) {
