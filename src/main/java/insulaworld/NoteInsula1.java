...
public class NoteInsula1 extends GuiScreen
{
    ...
    public NoteInsula1()
    {
        ...
        stringPageText[0] = "What a great place for getting armour\nBoots might help a bit!\nMine for jewels or crush Dirt / Stone?\nNeed to get fossils.";
        stringPageText[1] = "Transformer right click on tuneable blocks...\nNeed to collect 80 of each mob heart I think!\nDiagram shows Caelum as next world.";
