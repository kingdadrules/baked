...
public class NoteFrigus1 extends GuiScreen
{
    ...
    public NoteFrigus1()
    {
        ...
        stringPageText[0] = "I can spot blue ice blocks way below.\nLooks like lots of crusing & sieving will be needed.\nI can almost smell the way home now.";
        stringPageText[1] = "Let's get the mob hearts, make the activator, get back to Baked them HOME!!";
