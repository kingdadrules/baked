...
public class NoteMons1 extends GuiScreen
{
    ...
    public NoteMons1()
    {
        ...
        stringPageText[0] = "Ore spread in layers from top to bottom.\nShould make great armour.\n";
        stringPageText[1] = "Looks like a great heat source for crucible possibly?\nDiagram shows Coletus as next world.";
