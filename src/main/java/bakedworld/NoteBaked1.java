...
public class NoteBaked1 extends GuiScreen
{
    ...
    public NoteBaked1()
    {
        ...
        stringPageText[0] = "I WILL SURVIVE!\n\nFirst thing is to get some blocks to make a temporary shelter before dark.\nBest I reckon to get everything I need first then build a proper base.";
        stringPageText[1] = "Let's see..\n4 crafting table\n3 sword\n2 spade\n4 pickaxe\n7 wooden barrel\n5 sieve\n8 compost\nThat's about 33 dead cactus I will need.\nOh and 9 bits of string as well.";
        stringPageText[2] = "Food .. I've found nothing in the open desert, might be worth searching in the cracks and gullies instead.\nDirt.. Compost barrel?\nSieve.. baked dirt? Cobblestone?";
        stringPageText[3] = "If I remember right, clinker is top 3/4, waterstone lower & lavastone at the bottom.";
        stringPageText[4] = "Sort out permanent water source ASAP..Oak Tree ... crook=silkworm=string\nClinker for iron or sieve cobble?\n1 Lavastone + 3 Waterstone should be enough.\nNoteium reconstructs old notes, get ASAP.";    
