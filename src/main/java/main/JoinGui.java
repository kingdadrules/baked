...
public class JoinGui extends GuiScreen
{
    ...
    public JoinGui()
    {
        ...
        bookPageTextures[0] = new ResourceLocation(main.baked.modId + ":textures/gui/bgjoin.png"); 
        
        stringPageText[0] = "\n          BAKED\n \n   By kingdadrules";
        stringPageText[1] = "Kidnapped by space pirates and held to ransom, you handed over everything you own to buy your freedom.\nEventually they teleported you & left you to die alone on this planet, far off the normal space routes, with nothing but the clothes you have on.";

        stringPageText[2] = "Find a way to survive on this dustbowl of a word, baked near dry by it's relentless sun and inhabited only by hostile monsters. \n\nThen try to find a way back to your home planet.";
