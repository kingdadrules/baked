...
public class BathisRedOre extends BlockBase {

	public BathisRedOre(String name) {
	...
	public Item getItemDropped(IBlockState state, Random random, int i2 ){
		return ModItems.bathisredjewel;
	}
	...
	@Override
	public BathisRedOre setCreativeTab(CreativeTabs tab) {
